    ...
    <AnimatePresence>
      {active && typeof active === "object" && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 bg-black/[0.20] h-full w-full z-10" />
      )}
    </AnimatePresence>
    <AnimatePresence>
      {active && typeof active === "object" ? (
              ...
              <div className="flex justify-between items-start p-4">
                <div className="">
                  <motion.h3
                    ...
                    className="font-bold bg-gradient-to-b from-red-600 to-violet-800 bg-clip-text text-transparent dark:text-neutral-200">
                    {active.title}
                  </motion.h3>
                  <motion.p
